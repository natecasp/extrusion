...
function validate(wallMin, wallMax, refTol, wallTol, isSoft){
  ...
  if(isSoft) {var refTarget = $("#od-4").is(":checked"); var refTolerance = $("#od-tol-2").val();} else {var refTarget = $("#id-3").is(":checked"); var refTolerance = $("#id-tol-2").val();};
  var wallTolerance = $("#wall-tol").val();
  var length = Number($("#length-2").val());
  if((wall >= wallMin && wall <= wallMax) && (length <=60) && (length >=12) && (refTarget == true) && (qty <= 300) && ( id <= 0.300 ) && ( id >= 0.014 ) && (lengthTol == 'min') && (material !== '') && (Number(refTol) == Number(refTolerance)) && (Number(wallTol) == Number(wallTolerance))) { 
...
function validate(wallMin, wallMax, refTol, wallTol, isSoft){
  ...
  var wallTolerance = $("#wall-tol").val();
  var length = Number($("#length-2").val());
  if((wall >= wallMin && wall <= wallMax) && (length <=1524) && (length >=304) && (refTarget == true) && (qty <= 300) && ( id <= 7.62 ) && ( id >= 0.355 ) && (lengthTol == 'min') && (material !== '') && (Number(refTol) == Number(refTolerance)) && (Number(wallTol) == Number(wallTolerance))) { 
    $("#custom-quote").prop('checked', false);
    $("#custom-quote").trigger('change');
    greenlight.prop('checked', true);
    greenlight.trigger('change'); 
