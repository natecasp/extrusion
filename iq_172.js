...
var cert = $('#'+ $('input[data-name=cert]:checked').val()).val();
var unit = $("#unit").val();
...
var certId = 'level-'+$("#l"+line+"-cert").val()
$("#"+radioId).prop('checked', true);
$("#"+certId).prop('checked', true);
   }
...
$("#l"+ line + "-quantity").val($("#quantity-2").val());
 if(!$("#custom-quote").is(":checked")){
$("#l"+ line + "-cert").val($('#'+ $('input[data-name=cert]:checked').val()).val());
