...
$("#material-2").on('change', function() {
  $(this).css('border', '0px');
  calculate(true);
  if (['Pebax 25D','Pebax 35D','Pebax 55D', 'Pebax 63D', 'Pebax 72D', 'Pebax 45D'].includes(this.value)) { $("#color-2").empty().append('<option value="None">None</option><option value="20% BaSO4">20% BaSO4</option><option value="Mobilize">Mobilize</option><option value="BaSO4 & Mobilize">BaSO4 & Mobilize</option>'); }
  if (['Pebax 40D','Pebax 70D'].includes(this.value)) { $("#color-2").empty().append('<option value="None">None</option><option value="20% BaSO4">20% BaSO4</option>'); }
  if (['Vestamid ML21 (Nylon 12)'].includes(this.value)) { $("#color-2").empty().append('<option value="None">None</option><option value="20% BaSO4">20% BaSO4</option><option value="Mobilize">Mobilize</option>'); }
