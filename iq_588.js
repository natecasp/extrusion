...
function checkRefDimension() {
  if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax 74D', 'Vestamid ML21','Grilamid L25'].includes($("#material-2").val()) ){
  if(($(this).val() == 'id')) {
    $("#id-3").find('span').addClass('error-ref');
    $("#id-ref-popup").removeClass('hide-price');
  } else if (($(this).val() == 'wall')) {
    $("#wall-2").find('span').addClass('error-ref');
    $("#wall-ref-popup-high").removeClass('hide-price');
  } else {
    $("#wall-2").find('span').removeClass('error-ref');
    $("#id-3").find('span').removeClass('error-ref');
  ...
  if(($(this).val() == 'od')) {
    $("#od-4").find('span').addClass('error-ref');
    ...
    $("#wall-2").find('span').removeClass('error-ref');
    $("#od-4").find('span').removeClass('error-ref');
