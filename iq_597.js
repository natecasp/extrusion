...
if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax 74D', 'Vestamid ML21','PET','Acetal','Grilamid L25'].includes($("#material-2").val()) ){
  ...
  if(id >= 6.36 && id <= 7.62) { 
    if(isTol == false) {if(!$("#id-tol-2").val() == 'REF') { $("#id-tol-2").val(0.076);} if(!$("#od-tol-2").val() == 'REF') { $("#od-tol-2").val(0.076);} if(!$("#wall-tol").val() == 'REF') { $("#wall-tol").val(0.05);}} var yellowWallMin = 0.1524; var yellowWallTol = 0.050; var yellowWallMax = 0.762; var yellowRefTol = 0.076; var wallMin = 0.152; var wallMax = 0.635;  var refTol = 0.076; var wallTol = 0.051;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
   if(id> 7.62) {
    if(isTol == false) {if(!$("#id-tol-2").val() == 'REF') { $("#id-tol-2").val(0.076);} if(!$("#od-tol-2").val() == 'REF') { $("#od-tol-2").val(0.076);} if(!$("#wall-tol").val() == 'REF') { $("#wall-tol").val(0.05);}} var yellowWallMin = 0.1524; var yellowWallTol = 0.050; var yellowWallMax = 0.762; var yellowRefTol = 0.076; var wallMin = 0.152; var wallMax = 0.635;  var refTol = 0.076; var wallTol = 0.051;
...
if($(this).val() == 'id' && $(this).is(":checked")) {  $("#id-tol-2").val('REF'); $("#id-2, #id-range, #id-tol-2").prop('disabled', true); $("#od-3, #od-range, #wall, #wall-range, #od-tol-2, #wall-tol").prop('disabled', false);  calculate(false);}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#od-tol-2").val('REF'); $("#od-3, #od-range, #od-tol-2").prop('disabled', true); $("#id-2, #id-range, #wall, #wall-range, #wall-tol, #id-tol-2").prop('disabled', false);  calculate(false);}
if($(this).val() == 'wall' && $(this).is(":checked")) {  $("#wall-tol").val('REF'); $("#wall, #wall-range, #wall-tol").prop('disabled', true); $("#id-2, #id-range, #od-3, #od-range, #od-tol-2, #id-tol-2").prop('disabled', false);  calculate(false);}
...
if($(":radio[value=wall]").is(":checked")) {
  $("#wall, #wall-range").val(((Number($("#id-2").val())-Number(getValue))/2).toFixed(wsig)).trigger('change');
};
