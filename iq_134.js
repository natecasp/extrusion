...
$("#price-block").css('display', 'none');
  ...
  } else { createLine(); $("#price-block").css('display', 'none'); setTimeout(function() {document.querySelectorAll('.input-remove').forEach(e => e.remove());$("#quote-panel").css('display', 'flex');}, 100);}
}
});
