...
$("#next-step").removeClass('hide-price');
  ...
  //else { createLine(); $("#price-block").css('display', 'none'); $("#quote-panel").css('display', 'flex'); $(".lil-gui").css('display', 'none'); styles();}
}
});
