...
if($(this).val() == 'id' && $(this).is(":checked")) {  $("#id-2, #id-range, #id-tol-2").prop('disabled', true); $("#od-3, #od-range, #wall, #wall-range, #od-tol-2, #wall-tol").prop('disabled', false); $(this).val('REF');}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#od-3, #od-range, #od-tol-2").prop('disabled', true); $("#id-2, #id-range, #wall, #wall-range, #wall-tol, #id-tol-2").prop('disabled', false); $(this).val('REF');}
if($(this).val() == 'wall' && $(this).is(":checked")) {  $("#wall, #wall-range, #wall-tol").prop('disabled', true); $("#id-2, #id-range, #od-3, #od-range, #od-tol-2, #id-tol-2").prop('disabled', false); $(this).val('REF');}
});
