...
if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax 74D', 'Vestamid ML21','PET','Acetal','Grilamid L25'].includes($("#material-2").val()) ){
  ...
  //CATEGORY 1 .355-.1.27
  if(id >= 0.355 && id <= 1.27) { 
  if(isTol == false) {$("#id-tol-2").val(0.025); $("#wall-tol").val(0.013);} var yellowWallMin = 0.0380; var yellowWallTol = 0.0127; var yellowWallMax = 0.3175; var yellowRefTol = 0.0127; var wallMin = 0.050; var wallMax = 0.254; var refTol = 0.025; var wallTol = 0.0127;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  ...
  if(id >= 3.82 && id <= 5.08) { 
    if(isTol == false) {$("#id-tol-2").val(0.05); $("#wall-tol").val(0.038);} var yellowWallMin = 0.0635; var yellowWallTol = 0.0127; var yellowWallMax = 0.635; var yellowRefTol = 0.050; var wallMin = 0.102; var wallMax = 0.635;  var refTol = 0.050; var wallTol = 0.0380;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
