...
function createArray() {
  ...
  if($('input[id="final-check"]').is(":checked") && (!$("#purchase-order-file").val())) {
  var fee = total * 0.03;
...
$("#no-po-checkout").click(function() {
  if ($('input[id="po-verification"]').is(":checked")) { $("#purchase-order-no-upload").val('no-upload');createArray(); $("#loading").css("display", "flex"); }
    else {  $('#verification').dialog("open"); }
