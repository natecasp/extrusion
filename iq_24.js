...
$("#4-week-date").text(dayjs().add(dayjs.duration({'days' : 28})).format(MMMM DD));
$("#3-week-date").text(dayjs().add(dayjs.duration({'days' : 21})).format(MMMM DD));
$("#2-week-date").text(dayjs().add(dayjs.duration({'days' : 14})).format(MMMM DD));
$("#1-week-date").text(dayjs().add(dayjs.duration({'days' : 7})).format(MMMM DD));
$("#2-day-date").text(dayjs().add(dayjs.duration({'days' : 2})).format(MMMM DD));

$("#4-week-price").on('change', function(){
$("#3-week-price").val(this.value+300);
$("#2-week-price").val(this.value+600);
$("#1-week-price").val(this.value+1100);
$("#2-day-price").val(this.value+1600);
});
function calculate() {
//IF MATERIAL IS HARD
var id = Number($("#id-2").val());
var wall = Number($("#wall").val());
if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax74D', 'Vestamid ML21 (Nylon 12)'].includes($("#material-2").val()) ){
...
if($(this).val() == 'id' && $(this).is(":checked")) { $("#id-2, #id-range").prop('disabled', true); $("#od-3, #od-range, #wall, #wall-range").prop('disabled', false); $("#id-tol-2").val("REF");}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#od-3, #od-range").prop('disabled', true); $("#id-2, #id-range, #wall, #wall-range").prop('disabled', false); $("#od-tol-2").val("REF");}
if($(this).val() == 'wall' && $(this).is(":checked")) { $("#wall, #wall-range").prop('disabled', true); $("#id-2, #id-range, #od-3, #od-range").prop('disabled', false); $("#wall-tol").val("REF");}
});
...
$("#wall").val(Number(this.value).toFixed(3));
var id = Number($("#id-range").val());
var od = Number($("#od-range").val());
...
if($(":radio[value=id]").is(":checked")) {
  ...
  $("#id-2, #id-range").val(od-(Number(this.value)*2));
  idController.setValue(od-(Number(this.value)*2));
};

if($(":radio[value=od]").is(":checked")) {
  $("#od-3, #od-range").val(id+(Number(this.value)*2));
  odController.setValue(id+(Number(this.value)*2));
};
