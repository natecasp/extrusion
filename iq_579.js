...
odController.setValue(originalOD * 25.4);
idController.setValue(originalID * 25.4);
console.log('original OD range: ' + originalOD)
var newOD = Number((Math.round((originalOD * 25.4)/0.025)*0.025))
console.log('new OD: ' + newOD)
$("#od-3").val(Number(newOD));
$("#od-range").val(Number(newOD));
