...
var od = Number($("#od-range").val());
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4;var min = 0.014; var max = 0.300;}else{var tol= 0.05;var sig = 3; var wsig = 3;var min = 0.355; var max = 7.62;}
...
if ($("#unit").val() == 'in'){var idMin = 0.014; var tol = 0.002;var sig = 3; var wsig = 4;}else{var idMin = 0.355; var tol= 0.05;var sig = 3; var wsig = 3;}
...
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4; var min = 0.018; var max = 0.350;}else{var tol= 0.05;var sig = 3; var wsig = 3;var min = 0.457; var max = 8.89;}
...
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4;}else{var tol= 0.05;var sig = 3; var wsig = 3;}
...
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4; var max = 0.05; var min = 0.0005;}else{var tol= 0.05;var sig = 3; var wsig = 3; var max = 1.27; var min = 0.0127;}
if(this.value > max) { this.value = max;}
else if(this.value < min) { this.value = min;}
...
$("#id-range,#id-2").val(Number((originalID / 25.4).toFixed(3)));
$("#len-range,#length-2").val(Number((originalLEN / 25.4).toFixed(0)));
$("#od-range,#od-3").val(Number((originalOD / 25.4).toFixed(3)));
$("#wall, #wall-range").val(Number((originalWALL / 25.4).toFixed(4)));
...
$("#id-range,#id-2").val(Number((originalID * 25.4).toFixed(3)));
$("#len-range,#length-2").val(Number((originalLEN * 25.4).toFixed(0)));
$("#wall, #wall-range").val(Number((originalWALL * 25.4).toFixed(3)));
odController.setValue(originalOD * 25.4);
idController.setValue(originalID * 25.4);
$("#od-range,#od-3").val(Number((originalOD * 25.4).toFixed(3)));
