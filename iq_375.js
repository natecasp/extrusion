...
var wall = Number($("#wall-range").val());
if(Number(this.value) >= (od - tol)) {
var expandedOD = Number(this.value) + Number(tol);
...
$("#wall").on('input', function() {
  if($("#unit").val == 'in') {var max = 0.1; var min = 0.0005} else {var max = 2.54; var min = 0.0127;};
  if(this.value > max) { this.value = max;}
  if((this.value < min) && (this.value !== 0 || 0. || 0.0)) { this.value = min;}
});
