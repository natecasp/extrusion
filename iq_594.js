...
//IF MATERIAL IS SOFT
 ...
 //CATEGORY 1 .014-.050
  ...
  if (id < 0.014) {
    if(isTol == false) {$("#od-tol-2").val(0.001); $("#wall-tol").val(0.0005);} var yellowWallMin = 0.002; var yellowWallTol = 0.0005; var yellowWallMax = 0.01; var yellowRefTol = 0.001; var basePrice = 1200; var wallMin = 0.003; var wallMax = 0.010; var refTol = 0.001; var wallTol = 0.0005;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
    
  }
  
  if(id >= 0.014 && id <=0.050) { 
   if(isTol == false) {$("#od-tol-2").val(0.001); $("#wall-tol").val(0.0005);} var yellowWallMin = 0.002; var yellowWallTol = 0.0005; var yellowWallMax = 0.0125; var yellowRefTol = 0.001; var basePrice = 1200; var wallMin = 0.003; var wallMax = 0.010; var refTol = 0.001; var wallTol = 0.0005;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
...
if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax 74D', 'Vestamid ML21','PET','Acetal','Grilamid L25'].includes($("#material-2").val()) ){
  var basePrice = 900;
    if (id < 0.355) {
    if(isTol == false) {$("#id-tol-2").val(0.025); $("#wall-tol").val(0.013);} var yellowWallMin = 0.050; var yellowWallTol = 0.0127; var yellowWallMax = 0.25; var yellowRefTol = 0.025; var wallMin = 0.050; var wallMax = 0.254; var refTol = 0.025; var wallTol = 0.0127;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
    
  }
  //CATEGORY 1 .355-.1.27
  if(id >= 0.355 && id <= 1.27) { 
  if(isTol == false) {$("#id-tol-2").val(0.025); $("#wall-tol").val(0.013);} var yellowWallMin = 0.0381; var yellowWallTol = 0.0127; var yellowWallMax = 0.3175; var yellowRefTol = 0.0127; var wallMin = 0.050; var wallMax = 0.254; var refTol = 0.025; var wallTol = 0.0127;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  //CATEGORY 2 1.2954 - 2.54
  if(id >= 1.28 && id <= 2.54) { 
    if(isTol == false) {$("#id-tol-2").val(0.025); $("#wall-tol").val(0.025);} var yellowWallMin = 0.0635; var yellowWallTol = 0.025; var yellowWallMax = 0.50; var yellowRefTol = 0.0127; var wallMin = 0.076; var wallMax = 0.381; var refTol = 0.025; var wallTol = 0.025;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  //CATEGORY 3 2.5654 - 3.81
  if(id >= 2.55 && id <= 3.81 ) { 
    if(isTol == false) {$("#id-tol-2").val(0.038); $("#wall-tol").val(0.025);} var yellowWallMin = 0.0635; var yellowWallTol = 0.0127; var yellowWallMax = 0.50; var yellowRefTol = 0.025; var wallMin = 0.076; var wallMax = 0.508;  var refTol = 0.038; var wallTol = 0.025;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  //CATEGORY 4 3.8354 - 5.08
  if(id >= 3.82 && id <= 5.08) { 
    if(isTol == false) {$("#id-tol-2").val(0.05); $("#wall-tol").val(0.038);} var yellowWallMin = 0.0635; var yellowWallTol = 0.0127; var yellowWallMax = 0.635; var yellowRefTol = 0.050; var wallMin = 0.102; var wallMax = 0.635;  var refTol = 0.050; var wallTol = 0.0381;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  //CATEGORY 5 5.105 - 6.35
  if(id >= 5.09 && id <= 6.35) { 
    if(isTol == false) {$("#id-tol-2").val(0.064); $("#wall-tol").val(0.038);} var yellowWallMin = 0.127; var yellowWallTol = 0.0380; var yellowWallMax = 0.635; var yellowRefTol = 0.064; var wallMin = 0.127; var wallMax = 0.635;  var refTol = 0.064; var wallTol = 0.0380;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
  //CATEGORY 6 6.375 - 7.62
  if(id >= 6.36 && id <= 7.62) { 
    if(isTol == false) {$("#id-tol-2").val(0.076); $("#wall-tol").val(0.05);} var yellowWallMin = 0.1524; var yellowWallTol = 0.050; var yellowWallMax = 0.762; var yellowRefTol = 0.076; var wallMin = 0.152; var wallMax = 0.635;  var refTol = 0.076; var wallTol = 0.051;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
   if(id> 7.62) {
    if(isTol == false) {$("#id-tol-2").val(0.76); $("#wall-tol").val(0.05);} var yellowWallMin = 0.1524; var yellowWallTol = 0.050; var yellowWallMax = 0.762; var yellowRefTol = 0.076; var wallMin = 0.152; var wallMax = 0.635;  var refTol = 0.076; var wallTol = 0.051;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
...
if (id < 0.355) {
    if(isTol == false) {$("#od-tol-2").val(0.025); $("#wall-tol").val(0.0127);} var yellowWallMin = 0.050; var yellowWallTol = 0.0127; var yellowWallMax = 0.25; var yellowRefTol = 0.025; var wallMin = 0.076; var wallMax = 0.25; var refTol = 0.025; var wallTol = 0.0127;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
...
//CATEGORY 1 .355-.1.27
  if(id >= 0.355 && id <= 1.27) { 
  if(isTol == false) {$("#od-tol-2").val(0.025); $("#wall-tol").val(0.0127);} var yellowWallMin = 0.050; var yellowWallTol = 0.0127; var yellowWallMax = 0.3175; var yellowRefTol = 0.025; var wallMin = 0.076; var wallMax = 0.25; var refTol = 0.025; var wallTol = 0.0127;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
  ...
  //CATEGORY 2 1.2954 - 2.54
  if(id >= 1.28 && id <= 2.54) { 
    if(isTol == false) {$("#od-tol-2").val(0.025); $("#wall-tol").val(0.025);} var yellowWallMin = 0.076; var yellowWallTol = 0.0127; var yellowWallMax = 0.380; var yellowRefTol = 0.025; var wallMin = 0.076; var wallMax = 0.380; var refTol = 0.025; var wallTol = 0.025;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
  }
  //CATEGORY 3 2.5654 - 3.81
  if(id >= 2.55 && id <= 3.81 ) { 
    if(isTol == false) {$("#od-tol-2").val(0.0380); $("#wall-tol").val(0.025);} var yellowWallMin = 0.076; var yellowWallTol = 0.025; var yellowWallMax = 0.50; var yellowRefTol = 0.0380; var wallMin = 0.076; var wallMax = 0.50;  var refTol = 0.0380; var wallTol = 0.025;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
  }
  //CATEGORY 4 3.8354 - 5.08
  if(id >= 3.82 && id <= 5.08) { 
    if(isTol == false) {$("#od-tol-2").val(0.050); $("#wall-tol").val(0.0380);} var yellowWallMin = 0.102; var yellowWallTol = 0.025; var yellowWallMax = 0.635; var yellowRefTol = 0.050; var wallMin = 0.102; var wallMax = 0.635;  var refTol = 0.050; var wallTol = 0.0380;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
   ...
   //CATEGORY 5 5.105 - 6.35
  if(id >= 5.09 && id <= 6.35) { 
    if(isTol == false) {$("#od-tol-2").val(0.064); $("#wall-tol").val(0.0380);} var yellowWallMin = 0.127; var yellowWallTol = 0.0380; var yellowWallMax = 0.635; var yellowRefTol = 0.0635; var wallMin = 0.127; var wallMax = 0.635;  var refTol = 0.0635; var wallTol = 0.0380;
    var basePrice = 1350;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
  ...
  //CATEGORY 6 6.375 - 7.62
  if(id >= 6.36 && id <= 7.62) { 
    if(isTol == false) {$("#od-tol-2").val(0.076); $("#wall-tol").val(0.050);} var yellowWallMin = 0.152; var yellowWallTol = 0.050; var yellowWallMax = 0.635; var yellowRefTol = 0.076; var wallMin = 0.152; var wallMax = 0.635;  var refTol = 0.076; var wallTol = 0.050;
    var basePrice = 1350;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
...
$("span.radio-button-label-3").removeClass('ref-error');
...
$("#title-"+$(this).val()).siblings('p').addClass('low-opacity');
$(".input-box, .tol-box").removeClass('low-opacity');
$(this).parent().siblings('div').addClass('low-opacity');
if($(this).val() == 'id' && $(this).is(":checked")) {  $("#id-tol-2").val('REF'); $("#id-2, #id-range, #id-tol-2").prop('disabled', true); $("#od-3, #od-range, #wall, #wall-range, #od-tol-2, #wall-tol").prop('disabled', false); if($("#wall-tol").val() == 'REF') {$("#wall-tol").val(0.001)}; if($("#od-tol-2").val() == 'REF') {$("#od-tol-2").val(0.001)}; calculate(true);}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#od-tol-2").val('REF'); $("#od-3, #od-range, #od-tol-2").prop('disabled', true); $("#id-2, #id-range, #wall, #wall-range, #wall-tol, #id-tol-2").prop('disabled', false); if($("#wall-tol").val() == 'REF') {$("#wall-tol").val(0.001)}; if($("#id-tol-2").val() == 'REF') {$("#id-tol-2").val(0.001)}; calculate(true);}
if($(this).val() == 'wall' && $(this).is(":checked")) {  $("#wall-tol").val('REF'); $("#wall, #wall-range, #wall-tol").prop('disabled', true); $("#id-2, #id-range, #od-3, #od-range, #od-tol-2, #id-tol-2").prop('disabled', false); if($("#id-tol-2").val() == 'REF') {$("#id-tol-2").val(0.001)}; if($("#od-tol-2").val() == 'REF') {$("#od-tol-2").val(0.001)}; calculate(true);}
