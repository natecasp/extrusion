...
if (['Pebax 45D','Pebax 55D','Pebax 63D', 'Pebax 70D', 'Pebax 72D', 'Pebax 74D', 'Vestamid ML21','PET','Acetal','Grilamid L25'].includes($("#material-2").val()) ){
  ...
  if(id >= 5.09 && id <= 6.35) { 
    if(isTol == false) {$("#id-tol-2").val(0.064); $("#wall-tol").val(0.038);} var yellowWallMin = 0.127; var yellowWallTol = 0.0381; var yellowWallMax = 0.635; var yellowRefTol = 0.064; var wallMin = 0.127; var wallMax = 0.635;  var refTol = 0.064; var wallTol = 0.0381;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, false);
  }
...
if (id < 0.355) {
    if(isTol == false) {$("#od-tol-2").val(0.03); $("#wall-tol").val(0.013);} var yellowWallMin = 0.0508; var yellowWallTol = 0.0127; var yellowWallMax = 0.254; var yellowRefTol = 0.025; var wallMin = 0.0762; var wallMax = 0.254; var refTol = 0.03; var wallTol = 0.013;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
...
//CATEGORY 1 .355-.1.27
  if(id >= 0.355 && id <= 1.27) { 
  if(isTol == false) {$("#od-tol-2").val(0.03); $("#wall-tol").val(0.013);} var yellowWallMin = 0.0508; var yellowWallTol = 0.0127; var yellowWallMax = 0.3175; var yellowRefTol = 0.025; var wallMin = 0.0762; var wallMax = 0.254; var refTol = 0.03; var wallTol = 0.013;
    var basePrice = 1200;
    validate(basePrice, yellowWallMin, yellowWallMax, yellowRefTol, yellowWallTol, wallMin, wallMax, refTol, wallTol, true);
