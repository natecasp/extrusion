...
<div class="row">
    ...
    <div class="item"><p class="label">Price($)</p><input class="quote-input price" id="l`+lineItem+`-price" value="`+price+`" readonly></input></div>
...
function createArray() {
  ...
  $("#l-999-id").val("CC Processing Fee");
  $("#l-999-od").val(total * 0.03);
  let order = [];
  var lines = $(".line");
...
var output = JSON.stringify(order);
 $("#order").val(output);
  // $.ajax({
  //  type: 'POST',
  //  url: 'https://hook.us1.make.com/qshirpryu0qdlixjip7v5vfupb79xsro',
  //  dataType: 'json',
  //  data: output,
