...
var od = Number($("#od-range").val());
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4;var min = 0.014; var max = 0.300;}else{var tol= 0.05;var sig = 3; var wsig = 4;var min = 0.355; var max = 7.62; var step = 0.025;}
...
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4; var min = 0.018; var max = 0.350;}else{var tol= 0.05;var sig = 3; var wsig = 4;var min = 0.457; var max = 8.89; var step = 0.025;}
...
if ($("#unit").val() == 'in'){var tol = 0.002;var sig = 3; var wsig = 4; var max = 0.05; var min = 0.0005;}else{var tol= 0.05;var sig = 3; var wsig = 4; var max = 1.27; var min = 0.0127; var step = 0.0125;}
if(this.value > max) { this.value = max;}
else if(this.value < min) { this.value = min;}
$(this).val(Number((Math.round(this.value/step)*step).toFixed(sig)));
var getValue = $(this).val();
...
var originalOD  = Number($("#od-3").val());
var originalLEN = Number($("#length-2").val());
var originalWALL = Number($("#wall").val());
$("#id-range, #id-2").attr({
"min": 0.014,
"max": 0.300,
"step": 0.001
