...
if($(this).val() == 'id' && $(this).is(":checked")) { $("#id-2, #id-range").prop('readonly', true); $("#od-3, #od-range, #wall, #wall-range").prop('readonly', false); $("#id-tol-2").val("REF");}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#id-2, #id-range").prop('readonly', true); $("#id-2, #id-range, #wall, #wall-range").prop('readonly', false); $("#od-tol-2").val("REF");}
if($(this).val() == 'wall' && $(this).is(":checked")) { $("#wall, #wall-range").prop('readonly', true); $("#id-2, #id-range, #od-2, #od-range").prop('readonly', false); $("#wall-tol").val("REF");}
});
