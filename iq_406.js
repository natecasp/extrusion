...
$("#4-week-price").val(Number(this.value)*discount);
$("#4-week-discount").text('$' + Number(this.value));
$("#3-week-price").val((Number(this.value)+300)*discount);
$("#3-week-discount").text('$' + Number(this.value)+300);
$("#2-week-price").val((Number(this.value)+600)*discount);
$("#2-week-discount").text('$' + Number(this.value)+600);
$("#1-week-price").val((Number(this.value)+1100)*discount);
$("#1-week-discount").text('$' + Number(this.value)+1100);
$("#2-day-price").val((Number(this.value)+2100)*discount);
$("#2-day-discount").text(Number('$' + this.value)+2100);
});
