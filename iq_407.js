...
$("#4-week-price").val((Number(this.value)*discount).toFixed(2));
$("#4-week-discount").text('$' + (Number(this.value).toFixed(2)));
$("#3-week-price").val(((Number(this.value)+300)*discount).toFixed(2));
$("#3-week-discount").text('$' + (Number(this.value)+300).toFixed(2));
$("#2-week-price").val(((Number(this.value)+600)*discount).toFixed(2));
$("#2-week-discount").text('$' + (Number(this.value)+600).toFixed(2));
$("#1-week-price").val(((Number(this.value)+1100)*discount).toFixed(2));
$("#1-week-discount").text('$' + (Number(this.value)+1100).toFixed(2));
$("#2-day-price").val(((Number(this.value)+2100)*discount).toFixed(2));
$("#2-day-discount").text('$' + (Number(this.value)+2100).toFixed(2));
});
