...
var lineHtml = 
`<div class="line">
<p class="line-title">Line `+ lineItem +`</p>
	<div class="col">
		<input class="quote-input" id="l`+lineItem+`-id" value="`+id+`"></input>
  	<input class="quote-input" id="l`+lineItem+`-od" value="`+od+`"></input>
  	<input class="quote-input" id="l`+lineItem+`-length" value="`+length+`"></input>
    <input class="quote-input" id="l`+lineItem+`-material" value="`+material+`"></input>
    <input class="quote-input" id="l`+lineItem+`-quantity" value="`+quantity+`"></input>
	</div>
	<div class="col">
  	<input class="quote-input" id="l`+lineItem+`-id-tol" value="`+idTol+`"></input>
    <input class="quote-input" id="l`+lineItem+`-od-tol" value="`+odTol+`"></input>
    <input class="quote-input" id="l`+lineItem+`-length-tol" value="`+lenTol+`"></input>
    <input class="quote-input" id="l`+lineItem+`-additive" value="`+additive+`"></input>
    <input class="quote-input" id="l`+lineItem+`-price" value="`+price+`"></input>
  </div>
</div>`;
