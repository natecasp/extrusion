...
$("#id-range,#id-2").val((Math.round((originalID / 25.4)/0.001)*0.001).toFixed(3));
$("#len-range,#length-2").val((originalLEN / 25.4).toFixed(0));
$("#od-range,#od-3").val((Math.round((originalOD / 25.4)/0.001)*0.001).toFixed(3));
$("#wall, #wall-range").val((Math.round((originalWALL / 25.4)/0.0005)*0.0005).toFixed(4));
...
$("#id-range,#id-2").val((Math.round((originalID * 25.4)/0.025)*0.025).toFixed(3));
$("#len-range,#length-2").val((originalLEN * 25.4).toFixed(0));
$("#wall, #wall-range").val((Math.round((originalWALL * 25.4)/0.0125)*0.0125).toFixed(4));
odController.setValue(originalOD * 25.4);
idController.setValue(originalID * 25.4);
$("#od-range,#od-3").val((Math.round((originalOD * 25.4)/0.025)*0.025).toFixed(3));
