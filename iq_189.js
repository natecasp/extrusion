...
function styles() {
  ...
  for(var i = 0; i < greenlight.length; i++){
    ...
    line.find('.label').addClass('red-label');
    line.find('.line-title').addClass('red-label');
    line.find('.edit').addClass('red-label');
    line.addClass('red-line');
    }
    else {
    var line = $(greenlight[i]).closest('.line');
    line.find('.quote-input').removeClass('red-input');
    line.find('.label').removeClass('red-label');
    line.find('.line-title').removeClass('red-label');
    line.find('.edit').removeClass('red-label');
