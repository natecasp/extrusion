...
if($(this).val() == 'id' && $(this).is(":checked")) {  $("#id-tol-2").val('REF'); $("#id-2, #id-range, #id-tol-2").prop('disabled', true); $("#od-3, #od-range, #wall, #wall-range, #od-tol-2, #wall-tol").prop('disabled', false);}
if($(this).val() == 'od' && $(this).is(":checked")) { $("#od-tol-2").val('REF'); $("#od-3, #od-range, #od-tol-2").prop('disabled', true); $("#id-2, #id-range, #wall, #wall-range, #wall-tol, #id-tol-2").prop('disabled', false); }
if($(this).val() == 'wall' && $(this).is(":checked")) {  $("#wall-tol").val('REF'); $("#wall, #wall-range, #wall-tol").prop('disabled', true); $("#id-2, #id-range, #od-3, #od-range, #od-tol-2, #id-tol-2").prop('disabled', false); }
});
...
var output = JSON.stringify(order);
 ...
 $("#billing-address-submit").val(JSON.stringify(JSON.parse(localStorage.getItem("pocketbase_auth")).model.billing_address));
 $("#shipping-address-submit").val(JSON.stringify(JSON.parse(localStorage.getItem("pocketbase_auth")).model.shipping_address));
 $("#quote").submit();
