...
$("#material-2").on('change', function() {
  ...
  if (['LDPE'].includes(this.value)) {$("#color-2").empty().append('<option value="20% BaSO4">20%BaSO4</option>'); $("#colorant").empty().append('<option value="Cool Grey (4C)">Cool Grey (4C)</option>')}
