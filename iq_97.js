...
function validate(wallMin, wallMax, idTol, wallTol){
  if((wall >= wallMin && wall <= wallMax) && (length <=60) && (length <=12) && (lengthTol == 'min') && (material !== '') && (Number(idTol) == Number(idTolerance)) && (Number(wallTol) == Number(wallTolerance))) { 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////// MM
  ...
  //VALIDATE
function validate(wallMin, wallMax, idTol, wallTol){
  if((wall >= wallMin && wall <= wallMax) && (length <=1524) && (length <=304) && (lengthTol == 'min') && (material !== '') && (Number(idTol) == Number(idTolerance)) && (Number(wallTol) == Number(wallTolerance))) { 
    greenlight.prop('checked', true);
    greenlight.trigger('change'); 
    $("#wall").css('border', 'none');
    $("#length-2").css('border', 'none');
