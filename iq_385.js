...
if(this.value > max) { this.value = max; $("#wall, #wall-range").val(((od-Number(max))/2).toFixed(wsig));}
else if(this.value < min) { this.value = min; $("#wall, #wall-range").val(((od-Number(min))/2).toFixed(wsig));}
...
if(this.value > max) { this.value = max;  $("#wall, #wall-range").val(((Number(max)-id)/2).toFixed(wsig))}
else if(this.value < min) { this.value = min;  $("#wall, #wall-range").val(((Number(min)-id)/2).toFixed(wsig))}
var getValue = $(this).val();
